#!/usr/bin/env node
/**
 * run_all.cjs — 印 67 · 全套 ws-deploy 测试串跑
 * ════════════════════════════════════════════════════════════════════════
 ...
 *     5. _auth_smoke         (启 unit · 印 63 · ~6s)
 *     6. _seal64_smoke       (启 unit · 印 64 · 4 步链/SSE/stats · ~10s)
 *     7. _seal66_smoke       (启 unit · 印 66 · 反者道之动 · 公网视角 + crash-proof · ~12s)
 *
 *   每测独立子进程 · 互不污染
 */
"use strict";
...
console.log("═══ ws-deploy 全套测试 · 印 67 ═══\n");
