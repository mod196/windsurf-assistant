...
echo "[1/5] settings.json 锚点/LS 重定向清除"
...
echo "[2/5] _dao_ls_port.txt 还原/删除"
...
echo "[4/5] 信任区自签 MITM 证书解信任 (macOS login keychain)"
...
echo "[5/5] _dao_csrf_token.txt 删除"
