...
**当前版**: **v9.9.29** · 印 160 · 终端会话池 · 七层污染一招治 · 反者道之动 · 弱者道之用

**整日**: 2026-05-19 (印 160 终端池 + 去芜存菁) · 印 159 v9.9.28 (detached spawn 自卸) · 印 158 v9.9.27 (软编码彻终)

---

## I · 主目结构 (5/19 去芜后 · 14 件 + 2 目)

```text
.
├── extension.js                                · 143 KB · ext-host 主入口 (v9.9.29)
├── package.json                                · 6.4 KB · 13 命令 · 4 配置
├── readme.md                                   · 26 KB · 长详说 (顶部 v9.9.28-9.9.16 史)
├── INDEX.md                                    · (本档) · 工程总览
├── LICENSE.txt                                 · Apache-2.0
├── .vscodeignore                               · vsce package 排除清单
│
├── dao-proxy-min-9.9.29.vsix                   · 123 KB · ★ 当前发行
│
...
└── vendor/bundled-origin/                      · ★ 真本源
    ├── source.js                                 · 124 KB · proxy 后台 · 字段级 proto · invertSP
...
cd dao-proxy-min-9.1.x-改良
.\install.ps1

# 路 2: GUI · 命令面板 → "Extensions: Install from VSIX..." → 选 dao-proxy-min-9.9.29.vsix

# 路 3: CLI
windsurf --install-extension dao-proxy-min-9.9.29.vsix --force
```
...
```text
若 v9.9.29 装即生效 → 期 ✓ · 「本源观照」三 dot 全亮 · 终端三命令可调
若仍诉问题 → 走 dao.purge (race 15s) 净卸再装
若欲查印 160 之实证 → readme.md 顶部 + _test_v9929_term_pool.js 之注
...
**2026-05-19 · 印 160 · 去芜存菁毕** · 14 件 + 2 目 + 5 vendor 真本源 · 全归 v9.9.29 一脉
